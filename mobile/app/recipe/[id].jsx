  ...
  useEffect(() => {
    const checkIfSaved = async () => {
      try {
        ...
        // The JavaScript Array.prototype.some() method tests whether at least one element 
        // in an array passes a condition defined by a provided callback function. 
    ...
    // Loading is true from the start so no need for the below line
    //   setLoading(true);
      try {
