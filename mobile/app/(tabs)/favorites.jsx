...
const FavoritesScreen = () => {
  ...
  useEffect(() => {
    ...
    loadFavorites();
    // without user.id dependency it would only fetch once on mount
    // so if user logs out and different user logs in, component
    // would still show first user's favourite
  }, [user.id]);
    ...
    <View style={favoritesStyles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={favoritesStyles.recipesSection}>
          {/* parent scrollview handles scrolling so scrollEnabled is false */}
          <FlatList
