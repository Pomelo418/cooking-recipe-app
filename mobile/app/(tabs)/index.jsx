...
const HomeScreen = () => {
  ...
  const loadData = async () => {
    try {
      ...
      // a static method in JavaScript that takes an iterable of promises 
      // (usually an array) and returns a single new promise. 
      // It resolves when, and only when, all of the input promises have successfully fulfilled.
      // It rejects immediately as soon as any single one of the input promises rejects 
      ...
      // load the data in the selected category
